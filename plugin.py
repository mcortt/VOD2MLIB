...
(slug: vod2mlib)
v1.16.0 — optional webhook notifications (Discord/Slack/generic JSON)
          summarising what a run added/refreshed/skipped/deleted, fired
          after Generate Movies/Series, Full rescan, and Clean up.
...
class Plugin:
    ...
    def _webhook_stats(self, action: str, result: Dict[str, Any]):
        ...
        the top level. total_changed excludes 'errors' and is used to decide
        whether a no-op run should be suppressed.
        """
